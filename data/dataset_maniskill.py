...
if __name__ == '__main__':
    ...
    observations = np.load("/home/yihe/ibc_torch/work_dirs/demos/hang_obs.npy", allow_pickle=True)
    actions = np.load("/home/yihe/ibc_torch/work_dirs/demos/hang_act.npy")

    dataset = particle_dataset(observations, actions)
    print(len(dataset))
    torch.save(dataset, '/home/yihe/ibc_torch/work_dirs/demos/hang_10traj.pt')
