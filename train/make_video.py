...
try:
  from train import mp4_video_wrapper  # pylint: disable=g-import-not-at-top
except ImportError:
  from train import oss_mp4_video_wrapper as mp4_video_wrapper  # pylint: disable=g-import-not-at-top
