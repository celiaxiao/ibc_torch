...
class BlockPushDiscontinuous(block_pushing.BlockPush):
  ...
  def dist(self, state, target):
    # Reward is 1. blocks is inside any target.
    return np.linalg.norm(state['block_translation']
